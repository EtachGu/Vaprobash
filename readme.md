...
```bash
# curl
$ curl -L https://raw.githubusercontent.com/EtachGu/Vaprobash/master/Vagrantfile > Vagrantfile

# wget
$ wget -O Vagrantfile https://raw.githubusercontent.com/EtachGu/Vaprobash/master/Vagrantfile
```
...
maybe  you should change the `sources.list`
